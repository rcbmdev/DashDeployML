...
div_x_var =  html.Div(
        children=[html.H4('Variável Eixo X: '), dd_x_var],
...
div_y_var =  html.Div(
        children=[html.H4('Variável Eixo Y: '), dd_y_var],
        className="six columns"
        )

app.layout = html.Div(children=[
        html.H1('Gráfico de Dispersão - Preço de Diamantes', style={'text-align': 'center'}),
        html.Div(
