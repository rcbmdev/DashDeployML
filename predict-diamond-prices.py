...
## App layout
app.layout = html.Div([
        html.H1('IDR Previsão Preço de Diamantes', style={'text-align': 'center'}),
        
        html.H2('Insira as características do diamante para obter o preço previsto'),
...
def show_prediction(carat, depth, table, x, y, z, cut, color, clarity): 
    ...
    return str("Previsão do Preço: {:,}".format(pred))
